...
description: 本仓库 Legado 书源工具链的用法——14 个 CLI 命令、SQLite 管理库、规则回放器、失效归因、AI 修复循环。批量处理书源时使用。
---
...
| `import-sources` | 安全导入外部源（新增待校验，冲突待审） |
| `review-imports` | 查看/批准冲突队列 |
